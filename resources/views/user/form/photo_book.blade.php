                        ...
                        <div class="col-xl-12">
                            <div class="slide-table">
                                <div class="slide-tablecell">
                                    <h2>Photography Package Booking</h2>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="single-con-info pt-50 pb-50">
                        ...
                        <p class="con-text">Number of Prints: {{$table->total_print}}</p>
                        <p>Photoshoot: {{$table->photo_shoot}}</p>
                        <p>Photographer: {{$table->photographers}}</p>
                        <p>Hours: {{$table->hours}}</p>
                        <p>Imported Album: &nbsp;{{$table->imported_album}}</p>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="contact-form-area">
                        ...
                        @endif
                        <form action="{{action('User\PackageBookingController@photo_book')}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <input type="hidden" name="photoPackageID" value="{{$table->photoPackageID}}">
                            <input type="hidden" name="packageName" value="{{$table->packageName}}">
                            <input type="hidden" name="packageType" value="{{$table->type}}">
                            ...
                            <div class="form-group" style="margin-top: 10px">
                                <label for="exampleFormControlSelect2" style="color: #898282;font-size: 14px;">Choose Photographer ( optional )</label>
